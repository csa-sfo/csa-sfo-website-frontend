...
const boardMembers = [
  ...
  {
    name: "Maxwell A. Teränen",
    role: "Marketing/Sponsorship Director",
    linkedin: "https://www.linkedin.com/in/mteranen/",
    image: "/lovable-uploads/members/max.jpeg"
  }
];
        ...
        <div className="container-site px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 lg:gap-8">
            {boardMembers.map((member, index) => (
              <Card key={member.name} className="text-center overflow-hidden h-full flex flex-col">
                <CardContent className="pt-8 pb-6 flex flex-col flex-grow">
                  ...
                  <p className="text-csa-blue font-medium mb-4 text-sm leading-tight min-h-[2.5rem]">{member.role}</p>
              ...
              {advisoryMembers.map((member, index) => (
                <Card key={member.name} className="text-center overflow-hidden h-full">
                  <CardContent className="pt-8 pb-6">
                    ...
                    <p className="text-csa-blue font-medium mb-4 text-sm leading-tight">{member.title}</p>
          ...
          <div className="flex justify-center">
            <div className="grid grid-cols-1 gap-6">
              {volunteers.map((volunteer, index) => (
                <Card key={`volunteer-${index}`} className="text-center overflow-hidden h-full max-w-xs">
                  <CardContent className="pt-8 pb-6">
                    <img
                      src={volunteer.image}
                    ...
                    />
                    <h3 className="text-lg font-semibold text-csa-navy mb-2">
                      {volunteer.name}
                    </h3>
